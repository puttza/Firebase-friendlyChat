...
class FCViewController: UIViewController, UITableViewDataSource, UITableViewDelegate,
  ...
  func configureDatabase() {
    ...
    // Listen for new message in the Firebase database
  ...
  func configureRemoteConfig() {
    ...
    // Fetch configs from the server is normally limited to 5 requests per hour.
  ...
  func fetchConfig() {
    ...
    // If in developer mode cacheExpiration is set to 0 so each fetch will retrieve value from
    // the server

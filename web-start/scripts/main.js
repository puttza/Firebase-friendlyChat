...
function FriendlyChat() {
  ...
  this.chgPassMenu = document.getElementById('change-pass');
  this.chgEmailMenu = document.getElementById('change-email');
  ...
  this.signInFbButton.addEventListener('click', this.signInFB.bind(this));

  this.chgPassMenu.addEventListener('click', function() {
...
FriendlyChat.prototype.saveMessage = function(e) {
  ...
  if (this.messageInput.value && this.checkSignedInWithMessage()) {
    ...
    // Add a new messenger entry to the Firebase Database.
...
FriendlyChat.prototype.signInFB = function() {
    ...
    this.auth.signInWithPopup(fbProvider);
};
...
FriendlyChat.prototype.saveMessagingDeviceToken = function() {
  ...
  firebase.messaging().getToken().then(function(currentToken) {
    if (currentToken) {
        console.log('Got FCM devide Token:', currentToken);
